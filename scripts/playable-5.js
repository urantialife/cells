...
// Interactive #5 - One neighbourhood transform, one generation

$(() => {
    const source = `
		<div class='arrays'>
			<p> Click to edit these input cells: </p>
		</div>
    `

    $('.playable.p5').each((i, self) => {
		...
		for(let i = 0; i < 2; i++){
			...
			if(i > 0){
				const title = $(`<p>Output cells: <b>◼︎ ◻︎ ◼︎ ➜ ◼︎</b></p>`)
